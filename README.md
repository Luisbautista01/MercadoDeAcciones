Se decidió implementar el patrón de diseño Adapter para el diseño de la aplicación para monitorear el mercado de acciones, pues este proporciona varias ventajas tales como: 
